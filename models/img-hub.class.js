export class ImageHub {
	...
	static BACKGROUND = {
		firstLayer: ["./img/5_background/layers/1_first_layer/1.png", "./img/5_background/layers/1_first_layer/2.png"],
		secondLayer: ["./img/5_background/layers/2_second_layer/1.png", "./img/5_background/layers/2_second_layer/2.png"],
		thirdLayer: ["./img/5_background/layers/3_third_layer/1.png", "./img/5_background/layers/3_third_layer/2.png"],
	...
	static BOTTLE = {
		...
		onGround: ["./img/6_salsa_bottle/1_salsa_bottle_on_ground.png", "./img/6_salsa_bottle/2_salsa_bottle_on_ground.png"],
	};
	...
	static STATUSBAR = {
		...
		icons: {
			...
			bottle: "./img/7_statusbars/3_icons/icon_salsa_bottle.png",
